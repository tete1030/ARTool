...
const static struct ar9300_fixup wdr4310_v1_0_my_fixup = {
    "Fix up calibration incomplete 5GHz, only works between 5745[149] and 5825[165]. Warning: fix up used inaccurate values (interpolated). Version 1.",
    ...
    {
        { { -14, 0, 156, 0, 0, 0 }, { -9, 0, 156, 0, 0, 0 }, { -4, 0, 157, 0, 0, 0 }, { -1, 0, 156, 0, 0, 0 },
            { -1, 0, 157, 0, 0, 0 }, { -3, 0, 156, 0, 0, 0 }, { -6, 0, 155, 0, 0, 0 }, { -11, 0, 157, 0, 0, 0 } },
        { { -16, 0, 156, 0, 0, 0 }, { -11, 0, 157, 0, 0, 0 }, { -6, 0, 157, 0, 0, 0 }, { -2, 0, 157, 0, 0, 0 },
            { -2, 0, 156, 0, 0, 0 }, { -5, 0, 157, 0, 0, 0 }, { -9, 0, 156, 0, 0, 0 }, { -15, 0, 157, 0, 0, 0 } },
        { { -15, 0, 157, 0, 0, 0 }, { -10, 0, 157, 0, 0, 0 }, { -5, 0, 158, 0, 0, 0 }, { -1, 0, 157, 0, 0, 0 },
            { -1, 0, 158, 0, 0, 0 }, { -4, 0, 158, 0, 0, 0 }, { -10, 0, 157, 0, 0, 0 }, { -14, 0, 157, 0, 0, 0 } }
    }
};
...
const static struct ar9300_revision wdr4310_v1_0_my = {
    "TL-WDR4310", "1.0", "my", "N/A", &wdr4310_v1_0_my_fixup, default_detect, &wdr4310_v1_0_my_data
};
